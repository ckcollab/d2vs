...
class SimpleScanningTestcases(OCRTestCases):
    ...
    def test_scanning_simple_works(self):
        self._check_scan("tests/test_data/simple/586_gold.png", "586 Gold", "Normal")
        self._check_scan("tests/test_data/simple/super_mana_potion.png", "Super Mana Potion", "Normal")

    def test_scanning_ethereal_works(self):
        self._check_scan("tests/test_data/ethereal/fascia.png", "Fascia", "Socketed/Ethereal")
